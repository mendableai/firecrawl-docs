...
FIRE-1 is an AI agent that enhances Firecrawl's scraping capabilities. It can control browser actions and navigate complex website structures to enable comprehensive data extraction beyond traditional scraping methods.
