...
<video
  ...
  loop
  playsInline
  src="/images/guides/cookbooks/ai-sdk-cookbook/firecrawl-ai-sdk-chatbot.mp4"
  aria-label="AI research assistant chatbot interface showing real-time web scraping with Firecrawl and conversational responses powered by OpenAI"
/>
...
```
  ...
  <Step title="Test the Basic Chat">
    ...
    <video
      ...
      loop
      playsInline
      src="/images/guides/cookbooks/ai-sdk-cookbook/simple-ai-sdk-chatbot.mp4"
      aria-label="Basic AI chatbot without web scraping capabilities"
    />
  </Step>
...
````
  ...
  <Step title="Test the Complete Application">
    ...
    <video
      ...
      loop
      playsInline
      src="/images/guides/cookbooks/ai-sdk-cookbook/active-firecrawl-tools-ai-sdk.mp4"
      aria-label="AI chatbot with active Firecrawl tools"
    />
