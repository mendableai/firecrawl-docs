...
<Warning>
  **Esta página documenta la API v0, en desuso desde el 1 de abril de 2025.** Se conserva como
  referencia histórica y no describe cómo funciona Firecrawl actualmente. Documentación
  actual: [SDK de Python](/es/sdks/python). Para migrar una integración v0 existente, consulta
