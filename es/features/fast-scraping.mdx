...
Para que se produzca un acierto de caché, estos parámetros deben coincidir exactamente entre la solicitud original y las posteriores: `url`, `mobile`, `location`, `waitFor`, `blockAds`, `screenshot` (habilitado/deshabilitado y de página completa) y el modo de proxy mejorado.
