...
<Info>Hemos simplificado la facturación para que extrae ahora use créditos, igual que los demás endpoints. Cada crédito equivale a 15 tokens. Consulta [Facturación](/es/billing) para ver cómo se relacionan los créditos con los precios de los planes; scrape y crawl se cobran a 1 crédito por página ([Costo de scrape](/es/features/scrape#scraping-a-url-with-firecrawl)).</Info>
...
Hemos simplificado la facturación para que Extrae ahora use créditos, igual que todos los demás endpoints. Cada crédito equivale a 15 tokens. Consulta [Facturación](/es/billing) para ver cómo se corresponden los créditos con los precios de los planes; el scrape y el crawl se facturan a 1 crédito por página ([Costo de scrape](/es/features/scrape#scraping-a-url-with-firecrawl)).

Puedes supervisar el uso de Extrae a través del [panel de control](https://www.firecrawl.dev/app/extract).
