...
* **Documentos PDF** (`.pdf`)
  ...
  * Markdown opcional por página y bloques de diseño tipados con cuadros delimitadores
  * Precio de 1 crédito por página. Consulta la [tarifa](https://firecrawl.dev/pricing) para más detalles.
  * Consulta las [opciones de PDF](/es/features/parse#pdf-options) para obtener la referencia completa: modos de procesamiento, límites de páginas, markdown por página y bloques de diseño.
