...
* **Normal** — las URL se verifican con [Google Web Risk](https://cloud.google.com/security/products/web-risk), que marca páginas y sitios asociados con malware, ingeniería social (phishing) y software no deseado. **+2 créditos por URL analizada.**
* **Zscaler** — las URL se verifican con el tenant de [Zscaler Internet Access](https://www.zscaler.com/products-and-solutions/zscaler-internet-access) (ZIA) de tu organización: las categorías de URL definidas por Zscaler que selecciones bloquear, además de tus categorías de URL personalizadas y listas de URL personalizadas. Consulta el [modo Zscaler](#zscaler-mode) a continuación. **Sin cargo por escaneo** — la clasificación se realiza en tu propio tenant.
