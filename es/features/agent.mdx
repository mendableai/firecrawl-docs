...
* **No requiere URL**: solo describe lo que necesitas mediante el parámetro `prompt`. Las URL son opcionales
* **Búsqueda web profunda**: busca y navega de forma autónoma en lo más profundo de los sitios para encontrar tus datos
