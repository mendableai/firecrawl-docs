---
title: 'Node'
description: 'Realiza scraping, rastrea y extrae datos estructurados de sitios web con el SDK de Firecrawl para Node.js.'
icon: 'node'
og:title: "SDK de Firecrawl para Node.js | Firecrawl"
og:description: "Realiza scraping, rastrea y extrae datos estructurados de sitios web con el SDK de Firecrawl para Node.js."
---
