---
title: 'Node'
description: 'Faça scraping, rastreamento e extração de dados estruturados em sites usando o Firecrawl SDK de Node.'
icon: 'node'
og:title: "SDK de Node | Firecrawl"
og:description: "Faça scraping, rastreamento e extração de dados estruturados em sites usando o Firecrawl SDK de Node."
---
...
import AgentWithSchemaNode from '/snippets/pt-BR/v2/agent/with-schema/js.mdx'
import AgentStatusNode from '/snippets/pt-BR/v2/agent/status/js.mdx'
...
Cada execução também registra um rastro de execução e snapshots do resultado, que você pode consultar com `getAgentTrace` e `getAgentSnapshot`. Consulte [Agent](/pt-BR/features/agent) para ver o schema de eventos e a lista completa de parâmetros.
