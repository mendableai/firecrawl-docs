---
title: 'Rust'
description: 'O SDK do Firecrawl para Rust é uma biblioteca que ajuda você a fazer scraping e rastreamento de sites com facilidade e a gerar dados em um formato pronto para uso com modelos de linguagem (LLMs).'
icon: 'rust'
og:title: "Rust SDK | Firecrawl"
og:description: "O SDK do Firecrawl para Rust é uma biblioteca que ajuda você a fazer scraping e rastreamento de sites com facilidade e a gerar dados em um formato pronto para uso com modelos de linguagem (LLMs)."
...
<Warning>
  **Esta página documenta a API v0, descontinuada em 1º de abril de 2025.** Ela é mantida como
  ...
  atual: [SDK do Firecrawl para Rust](/pt-BR/sdks/rust). Para migrar uma integração v0 existente, consulte
