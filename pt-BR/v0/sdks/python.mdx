---
title: 'Python'
description: 'O SDK Python do Firecrawl é um wrapper da API do Firecrawl que ajuda você a converter sites em markdown com facilidade.'
icon: 'python'
og:title: "SDK Python | Firecrawl"
og:description: "O SDK Python do Firecrawl é um wrapper da API do Firecrawl que ajuda você a converter sites em markdown com facilidade."
...
<Warning>
  **Esta página documenta a API v0, descontinuada em 1º de abril de 2025.** Ela é mantida como
  ...
  atual: [SDK Python](/pt-BR/sdks/python). Para migrar uma integração v0 existente, consulte
