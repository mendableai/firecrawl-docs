...
* **Documentos PDF** (`.pdf`)
  ...
  * Consulte as [opções de PDF](/pt-BR/features/parse#pdf-options) para a referência completa: modos de análise, limites de páginas, Markdown por página e blocos de layout.
