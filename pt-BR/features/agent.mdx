...
og:description: "Reúna dados em qualquer lugar da web. Descreva o que você quer e o /agent cuida do resto."
sidebarTitle: "agente"
icon: "magic"
noindex: true
...
* **Não requer URLs**: basta descrever o que você precisa pelo parâmetro `prompt`. As URLs são opcionais
* **Busca profunda na web**: pesquisa e navega de forma autônoma pelas camadas mais profundas dos sites para encontrar seus dados
* **Confiável e preciso**: funciona com uma ampla variedade de queries e casos de uso
* **Mais rápido**: processa múltiplas fontes em paralelo para resultados mais ágeis
