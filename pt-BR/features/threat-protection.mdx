...
* **Normal** — as URLs são verificadas com base no [Google Web Risk](https://cloud.google.com/security/products/web-risk), que sinaliza páginas e sites associados a malware, engenharia social (phishing) e software indesejado. **+2 créditos por URL verificada.**
