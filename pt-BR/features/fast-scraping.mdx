...
Para que haja um acerto de cache, estes parâmetros devem corresponder exatamente entre as requisições original e subsequentes: `url`, `mobile`, `location`, `waitFor`, `blockAds`, `screenshot` (captura de tela ativada/desativada e de página inteira) e o modo de proxy aprimorado.
