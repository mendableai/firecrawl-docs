...
| Scheduled monitoring and change detection | Cloud and self-hosted (core route); meaningful-change judging needs an LLM provider, as structured extraction does | [Monitoring](/features/monitoring) |
