...
* `/scrape`: 150 base credits + 0-900 variable agent credits (varies based on task complexity)
* `/extract`: See our [token calculator](https://www.firecrawl.dev/pricing?extract-pricing=true#token-calculator). Around 8x the cost of non-agent extract + 0-900 variable agent credits (varies based on task complexity)
