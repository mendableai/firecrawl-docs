...
**Note:** The FIRE-1 agent provides powerful capabilities but consumes additional credits: 150 base credits + 0-900 variable agent credits depending on the complexity of the navigation instructions and the number of pages interacted with.
...
## Considerations
- Using FIRE-1 consumes 150 base credits + 0-900 variable agent credits based on task complexity and interaction depth.
