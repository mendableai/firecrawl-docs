---
title: "Firecrawl のコントリビューター向けセットアップ"
sidebarTitle: "コントリビューターセットアップ"
description: "Firecrawl API の開発環境をセットアップし、ローカルでのスクレイピングを確認して、コントリビュート前にソース管理下のテストハーネスを実行します。"
og:title: "Firecrawl のコントリビューター向けセットアップ | Firecrawl"
og:description: "Firecrawl API の開発環境をセットアップし、ローカルでのスクレイピングを確認して、コントリビュート前にソース管理下のテストハーネスを実行します。"
---

API、ワーカー、テストを変更する場合は、Firecrawl をローカルで実行します。この手順では開発用の依存関係をインストールし、API ハーネスとともにソース管理下のサービスを起動します。
