...
* **オープンソース機能を追加しますか？** [セルフホスト環境での機能サポート](#self-hosted-feature-support) で必要なプロバイダーまたはサービスを確認し、その構成を単独でテストしてください。
* **Firecrawl のコードを変更しますか？** 開発環境については、[コントリビューター向けセットアップ](/ja/contributing/guide) を参照してください。
