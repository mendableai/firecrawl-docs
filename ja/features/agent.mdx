...
* **URL 不要**: `prompt` パラメータで必要な内容を伝えるだけです。URL の指定は任意です
* **Deep Web Search**: サイトの奥深くまで自律的に検索・移動して目的のデータを見つけ出します
* **信頼性と正確性**: 幅広いクエリやユースケースに対応します
* **高速**: 複数のソースを並列処理し、より早く結果を返します
