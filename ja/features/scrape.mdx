...
詳細は、[スクレイピング Endpoint APIリファレンス](https://docs.firecrawl.dev/api-reference/endpoint/scrape)を参照してください。

<PlaygroundCTA />

URL 上のドキュメントをスクレイピングしたいですか、それともディスク上のドキュメントを解析したいですか? ここでは、スクレイピング を使う場面と [Parse](/ja/features/parse) を使う場面を説明します:
