---
title: 'Rust'
description: 'Firecrawl Rust SDK 是一个库，帮助你轻松抓取与爬取网站，并以适用于大语言模型（LLM）的 格式 输出数据。'
icon: 'rust'
og:title: "Rust SDK | Firecrawl"
og:description: "Firecrawl Rust SDK 是一个库，帮助你轻松抓取与爬取网站，并以适用于大语言模型（LLM）的 格式 输出数据。"
canonical: "https://docs.firecrawl.dev/sdks/rust"
---

<Warning>
  **本页记录的是 v0 API，已于 2025 年 4 月 1 日弃用。** 保留此页仅供历史参考，
  并不反映 Firecrawl 当前的工作方式。最新文档：[Rust SDK](/zh/sdks/rust)。
