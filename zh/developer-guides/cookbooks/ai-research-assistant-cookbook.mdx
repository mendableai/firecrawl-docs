...
<Steps>
  ...
  <Step title="安装依赖项">
    <div id="install-ai-sdk-packages">
      ### 安装 AI SDK 包
    </div>
    ...
    * `zod`：用于工具输入的架构校验
    ...
    <div id="install-openai-provider">
      ### 安装 OpenAI Provider
    </div>
  ...
  <Step title="构建前端聊天界面">
    ...
    <div id="understanding-the-frontend">
      ### 了解前端
    </div>
  ...
  <Step title="添加 Firecrawl 工具">
    ...
    export const searchWebTool = tool({
      ...
      inputSchema: z.object({
        ...
        categories: z.array(z.enum(['developer', 'research', 'pdf'])).optional().describe('筛选类别'),
      }),
    ...
    <div id="understanding-the-tools">
      ### 了解这些工具
    </div>
