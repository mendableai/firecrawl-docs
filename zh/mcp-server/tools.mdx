...
| 搜索科学文献   | `firecrawl_research_*`                             | 您需要查找论文、阅读论文中的段落，或追溯引用。搜索 PubMed、bioRxiv、medRxiv 和 arXiv 论文摘要的[研究索引](/zh/features/research)。 |
...
<CardGroup cols={3}>
  ...
  <Card title="研究索引" href="/zh/features/research" icon="book-open">
    搜索论文、阅读段落并追踪引用。
  </Card>

  <Card title="开发者索引" href="/zh/features/developer" icon="code">
