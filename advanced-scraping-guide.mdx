...
- **Type**: `number`
- **Description**: Delay in seconds between crawl requests. This helps respect website rate limits and prevent overwhelming the target website. If not provided, the crawler may use the robots.txt crawl delay if available.
- **Default**: `undefined`
