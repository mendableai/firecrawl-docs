...
<Info>
**Try On-Demand Search - Pay-Per-Use Option**

Want to try Firecrawl's powerful search capabilities without a subscription? Our new [**On-Demand Search**](/x402/search) endpoint lets you pay per search using cryptocurrency!
</Info>
