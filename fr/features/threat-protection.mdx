...
* **Normal** — les URL sont vérifiées à l’aide de [Google Web Risk](https://cloud.google.com/security/products/web-risk), qui signale les pages et les sites associés à des logiciels malveillants, à l’ingénierie sociale (phishing) et à des logiciels indésirables. **+2 crédits par URL analysée.**
