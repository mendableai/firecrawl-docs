...
* `research` : limitez la recherche web aux **sites web** académiques et de recherche (arxiv.org, nature.com, ieee.org, pubmed.ncbi.nlm.nih.gov, biorxiv.org, medrxiv.org et sites similaires). Renvoie des résultats de pages web classiques avec des snippets — et non des fiches d’articles. Pour rechercher les articles eux-mêmes, utilisez le [Research Index](/fr/features/research)
...
<Note>
  **`research` est un filtre de sites web, et non l’index d’articles.** Il restreint la recherche web classique à une liste fixe de domaines académiques et renvoie les snippets des pages correspondantes.
  ...
  Pour rechercher la littérature scientifique — résumés complets, lecture de passages dans les articles et exploration du graphe de citations à partir d’un index d’articles de PubMed, bioRxiv, medRxiv et arXiv — utilisez plutôt le [Research Index](/fr/features/research).
</Note>
