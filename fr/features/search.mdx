...
* `research` : limite la recherche web aux sites universitaires et de recherche (arxiv.org, nature.com, pubmed.ncbi.nlm.nih.gov, et similaires). Évolue le 16/11/2026 pour interroger le [Research Index](/fr/features/research) et renvoyer des enregistrements de publications ; voir l&#39;avertissement ci-dessous
...
<Warning>
  **La catégorie `research` évolue le 16/11/2026.** Elle interrogera le [Research Index](/fr/features/research) (PubMed, bioRxiv, medRxiv, arXiv) au lieu de restreindre les résultats web à 14 sites universitaires. Les résultats passeront de `data.web` à `data.research` et seront renvoyés sous forme d&#39;enregistrements de publications : `paperId`, `primaryId`, `ids`, `title`, `abstract`, `score`. D&#39;ici là, chaque réponse qui l&#39;utilise contient une entrée `warnings`.

  Si vous souhaitez des enregistrements de publications, adaptez votre parsing avant cette date ou appelez dès aujourd&#39;hui [`GET /search/research/papers`](/fr/api-reference/endpoint/research-search-papers). Si vous souhaitez des pages web issues de sites universitaires, utilisez plutôt [`includeDomains`](#domain-filters).
</Warning>
...
Pour effectuer des recherches dans les publications elles-mêmes plutôt que sur les sites web qui les hébergent, utilisez le [Research Index](/fr/features/research), qui recherche dans les résumés de publications sur PubMed, bioRxiv, medRxiv et arXiv, et peut lire des passages au sein d’une publication :
  ...
  "data": {
    "web": [
      ...
      },
      {
        ...
        "title": "Panorama des réseaux de neurones",
        "description": "Un panorama des architectures de réseaux de neurones",
        "category": "pdf"
      }
    ]
  }
...
Des évaluateurs indépendants ont comparé Firecrawl recherche à d&#39;autres API de recherche. Les chiffres ci-dessous sont repris directement des résultats publiés par chaque évaluateur à la date indiquée.

| Métrique                                   | Valeur                                                      | Source                                                                         | Date                                          | n / ±                                                                                                                                                                                                                                         |
| ------------------------------------------ | ----------------------------------------------------------- | ------------------------------------------------------------------------------ | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Agent Score (moyenne pertinence × qualité) | 14,58, 2ᵉ sur 8 (pertinence moyenne 4,30/5, qualité 3,39/5) | [AIMultiple — Agentic recherche Benchmark](https://aimultiple.com/agentic-search) | Déc. 2025 (source mise à jour le 25 mai 2026) | IC 95 % 13,12–15,98, n=100 requêtes du domaine IA/LLM issues du trafic de recherche organique d&#39;AIMultiple (10 000 rééchantillonnages bootstrap) ; la source précise que les résultats ne sont pas généralisables à d&#39;autres domaines |

<Note>
  Il s&#39;agit de mesures réalisées par des tiers, chacune avec son propre harnais, son propre ensemble de tâches et sa propre méthodologie — elles ne sont donc pas directement comparables entre elles, ni aux benchmarks de Firecrawl. Estimation ponctuelle : 2ᵉ sur 8 ; les tests par bootstrap apparié n&#39;ont mis en évidence aucun écart statistiquement significatif face à Brave, Exa ou Parallel recherche Pro. Les pages de benchmarks réalisés par Firecrawl, y compris l&#39;évaluation open source du Developer Index, sont disponibles sur [firecrawl.dev/benchmarks](https://www.firecrawl.dev/benchmarks).
</Note>
