...
description: 'Détecter et surveiller les changements dans le contenu web entre les scrape'
og:title: "Change Tracking | Firecrawl"
sidebarTitle: "Suivi des modifications"
og:description: "Détecter et surveiller les changements dans le contenu web entre les scrape"
---

![Change Tracking](/images/launch-week/lw3d12.webp)

Le suivi des modifications compare le contenu actuel d’une page à celui de la dernière fois où vous l’avez extraite. Ajoutez `suiviDesModifications` à votre tableau `formats` pour détecter si une page est nouvelle, inchangée ou modifiée et, si vous le souhaitez, obtenir un diff structuré de ce qui a changé.
...
Le suivi des modifications est la primitive de diff appliquée à chaque scrape. Si vous souhaitez que Firecrawl exécute les vérifications selon une planification et vous notifie par webhook, e-mail ou Slack lorsque quelque chose change, utilisez le [monitoring](/fr/features/monitoring) plutôt que d’appeler `/scrape` vous-même à intervalles réguliers.
...
Le suivi des modifications est particulièrement utile lorsque vous effectuez du scraping à intervalles réguliers. Le [monitoring](/fr/features/monitoring) gère cette planification à votre place, jusqu&#39;à un intervalle de 5 minutes, et envoie des notifications par webhook, e-mail ou Slack. Utilisez les options ci-dessous si vous préférez gérer vous-même la planification à l&#39;aide de cron, de planificateurs cloud ou d&#39;outils de workflow.
