...
<Info>Nous avons simplifié la facturation afin qu’Extract utilise désormais des crédits, comme tous les autres points de terminaison. Chaque crédit équivaut à 15 tokens. Consultez [Facturation](/fr/billing) pour savoir comment les crédits correspondent à la tarification des offres ; scrape et crawl sont facturés 1 crédit par page ([Coût de Scrape](/fr/features/scrape#scraping-a-url-with-firecrawl)).</Info>
...
Nous avons simplifié la facturation afin qu’Extract utilise désormais des crédits, comme tous les autres points de terminaison. Chaque crédit vaut 15 tokens. Consultez [Facturation](/fr/billing) pour savoir comment les crédits se traduisent dans la tarification des offres ; scrape et crawl sont facturés 1 crédit par page ([Coût de Scrape](/fr/features/scrape#scraping-a-url-with-firecrawl)).
