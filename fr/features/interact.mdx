...
* **Réutiliser une session authentifiée** — enregistrez l&#39;état du browser dans un profil nommé et chargez-le lors de scrapes ultérieurs. See [Profils persistants avec Scrape + Interact](#persistent-profiles-with-scrape-+-interact).
