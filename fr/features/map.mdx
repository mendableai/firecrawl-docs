...
Si vous avez besoin d’une découverte récursive plus approfondie, avec des enregistrements de résultats et d’erreurs vérifiables plutôt qu’une approximation rapide, utilisez [/crawl](/fr/features/crawl) : il découvre les pages par parcours récursif des liens ainsi que via le sitemap, et indique ce qu’il a renvoyé et ce qu’il n’a pas réussi à récupérer — voir [Exécution et suivi des résultats](/fr/features/crawl#execution-and-result-accounting). Pour obtenir les liens d’une page en particulier, demandez le [format `links`](/fr/features/scrape#scrape-formats) à [/scrape](/fr/features/scrape).
