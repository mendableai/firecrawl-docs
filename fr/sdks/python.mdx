---
title: "Python"
description: "Le SDK Python Firecrawl est une surcouche à l’API Firecrawl qui vous aide à convertir facilement des sites web en Markdown."
icon: "python"
og:title: "SDK Python | Firecrawl"
og:description: "Le SDK Python Firecrawl est une surcouche à l’API Firecrawl qui vous aide à convertir facilement des sites web en Markdown."
---
...
Chaque exécution enregistre également une trace d’exécution et des instantanés de sortie, que vous pouvez consulter avec `get_agent_trace` et `get_agent_snapshot`. Consultez [Agent](/fr/features/agent) pour le schéma des événements et la liste complète des paramètres.
