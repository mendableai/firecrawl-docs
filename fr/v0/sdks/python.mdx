---
title: 'Python'
description: 'Le SDK Python Firecrawl est un SDK d’interface pour l’API Firecrawl, conçu pour transformer facilement des sites web en Markdown.'
icon: 'python'
og:title: "Python SDK | Firecrawl"
og:description: "Le SDK Python Firecrawl est un SDK d’interface pour l’API Firecrawl, conçu pour transformer facilement des sites web en Markdown."
...
<Warning>
  **Cette page documente l’API v0, dépréciée le 1er avril 2025.** Elle est conservée à
  ...
  actuelle : [SDK Python](/fr/sdks/python). Pour migrer une intégration v0 existante, consultez
  [Migrer depuis v0](/fr/migrating-from-v0).
</Warning>
