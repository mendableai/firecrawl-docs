---
title: 'Rust'
description: 'Le SDK Firecrawl pour Rust est une bibliothèque qui vous permet d’extraire et de crawler facilement des sites web, et de produire des données dans un format prêt à l’emploi pour les modèles de langage (LLM).'
icon: 'rust'
og:title: "Rust SDK | Firecrawl"
og:description: "Le SDK Firecrawl pour Rust est une bibliothèque qui vous permet d’extraire et de crawler facilement des sites web, et de produire des données dans un format prêt à l’emploi pour les modèles de langage (LLM)."
...
<Warning>
  **Cette page documente l’API v0, dépréciée le 1er avril 2025.** Elle est conservée à
  ...
  actuelle : [SDK Rust](/fr/sdks/rust). Pour migrer une intégration v0 existante, consultez
  [Migration depuis v0](/fr/migrating-from-v0).
</Warning>
