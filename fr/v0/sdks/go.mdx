...
<Warning>
  **Cette page documente l’API v0, abandonnée le 1er avril 2025.** Elle est conservée à
  titre de référence historique et ne décrit pas le fonctionnement actuel de Firecrawl. Documentation
  actuelle : [SDK Go](/fr/sdks/go). Pour migrer une intégration v0 existante, consultez
