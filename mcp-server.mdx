...
Use the url: http://localhost:3000/sse or https://mcp.firecrawl.dev/{FIRECRAWL_API_KEY}/sse
...
After adding the server, you can use Firecrawl's web scraping capabilities directly within Claude Code by asking Claude to scrape websites, crawl content, or perform web searches.
