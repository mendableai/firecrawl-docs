...
while True:
    ...
    # producer_sequence é monotônico por agente emissor, portanto agrupe antes.
    ...
    if not finished:
        ...
        # Janela final: eventos ainda podem chegar por um instante após o término da execução.
        quiet_polls += 1
        if quiet_polls == 3:
            break
