...
for (;;) {
  ...
  // producerSequence es monótono por agente emisor, así que primero agrupamos.
  ...
  if (!finished) {
    ...
    // Ventana final: aún pueden llegar eventos poco después de que termine la ejecución.
